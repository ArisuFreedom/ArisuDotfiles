...
# Emacs has a built-in package system.
# In this configuration we use straight.el, a modern package manager
# that clones packages directly from Git repositories.
